  ...
  return (
    ...
    <div>
      <Service_Hero
        ...
        text="Our mobile app development services focus on delivering high-quality and user-friendly apps for both iOS and
          Android. We build apps that are not only functional but also provide a seamless user experience."
        image={AppDevImage}
        contactLink="/contact"
    ...
    <div className="max-w-screen-xl mx-auto p-6">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-600 mb-4">
          Our app development process is structured to ensure efficient delivery
          with the highest quality. We follow a streamlined approach to create
          apps that meet your specific requirements.
        </p>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-600 mb-4">
          Investing in mobile app development offers various advantages for your
          business, including increased brand visibility, improved customer
          engagement, and more efficient processes.
        </p>
